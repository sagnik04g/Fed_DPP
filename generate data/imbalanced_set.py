...
# # Load the dataset
 ...
 mnist_save_file=f'../data/imbalanced/{split}/mnist_data_40clients{split}_invdpp_s={s}.pickle'  
 with open(mnist_save_file, 'wb') as f:
    pickle.dump(mnist_dict,f)
    print('MNIST imbalanced partitions saved')

 femnist_json_path=f'../data/femnist/data/all_data_0_niid_05_keep_64_{split}_8.json'
 celeba_json_path=f'../data/celeba/data/{split}/all_data_0_0_keep_3_{split}_9.json'
 shakespeare_json_path=f'../data/shakespeare/data/{split}/all_data_0_0_keep_0_{split}_9.json'
 ...
 femnist_save_path=f'../data/imbalanced/{split}/femnist_data_{split}_invdpp_s={s}.pickle'
 ...
 image_path = '../data/celeba/data/raw/img_align_celeba/'
 ...
 celeba_save_path=f'../data/imbalanced/{split}/celeba_data_{split}_invdpp_s={s}.pickle'
 ...
 shakespeare_save_path=f'../data/imbalanced/{split}/shakespearer_data_{split}_invdpp_s={s}.pickle'
